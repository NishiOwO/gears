...
LDFLAGS =
LIBS = `pkg-config --libs tcl 2>/dev/null` `pkg-config --libs tk 2>/dev/null` `pkg-config --libs tcl$(TCLTK_VERSION) 2>/dev/null` `pkg-config --libs tk$(TCLTK_VERSION) 2>/dev/null`
BUILD_DEPS = false
